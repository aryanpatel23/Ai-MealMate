    ...
    try {
      ...
      if (error instanceof Error) {
        if (error.message.includes("Failed to fetch")) {
          errorMessage = "Google OAuth is not configured. Please contact support or try email login instead."
        ...
        <div className="flex flex-col gap-6">
          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <CardDescription>Sign in to your AI MealMate account</CardDescription>
            </CardHeader>
            <CardContent>
